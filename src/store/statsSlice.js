...
export const getUsersCount = createAsyncThunk("getUsersCount", async() => {
    try {
        const res = await axios.get(
            "https://walidelgendy.e3lanotopia.software/api/th/get_users_count"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getViews = createAsyncThunk("getViews", async() => {
    try {
        const res = await axios.get(
            "https://walidelgendy.e3lanotopia.software/api/th/get_videos_views"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getLessonsCount = createAsyncThunk("getLessonsCount", async() => {
    try {
        const res = await axios.get(
            "https://walidelgendy.e3lanotopia.software/api/th/get_lessons_count"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const getExamsCount = createAsyncThunk("getExamsCount", async() => {
    try {
        const res = await axios.get(
            "https://walidelgendy.e3lanotopia.software/api/th/get_exames_count"
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const deleteCourse = createAsyncThunk("deleteCourse", async(args) => {
    try {
        const res = await axios.get(
            `https://walidelgendy.e3lanotopia.software/api/th/delete_course/${args}`
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const deleteLesson = createAsyncThunk("deleteLesson", async(args) => {
    try {
        const res = await axios.get(
            `https://walidelgendy.e3lanotopia.software/api/th/delete_lesson/${args}`
        );
        return res.data;
    } catch (err) {
        return err.message;
...
export const editLesson = createAsyncThunk("editLesson", async(args) => {
    try {
        const res = await axios.post(
            `https://walidelgendy.e3lanotopia.software/api/th/edit_lesson/${args.id}`,
            args.data
        );
...
export const editCourse = createAsyncThunk("editCourse", async(args) => {
    ...
    try {
        const res = await axios.post(
            `https://walidelgendy.e3lanotopia.software/api/th/edit_course/${args.id}`,
            args.data
        );
